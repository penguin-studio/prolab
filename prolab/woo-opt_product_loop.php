            ...
            <div class="product-desc">
                ...
                <div class="product-text">
                    ...
                    <?php if ($product_weight_gr = get_post_meta($post->ID,'product-weight-gr', true)): ?>
                        <p class="weight"><b>Вес: </b><?php echo $product_weight_gr; ?> грамм</p>
                    <?php endif?>
                ...
                <div class="quantity-items">
                    <div class="quantity-items__desc">
                        ...
                        foreach($product->get_children() as $_product_id){
                            ...
                            $var_name = get_term_by('slug', $mas['attribute_pa_vkus'],'pa_vkus')->name.'<br>';//код дляполучения имени вариации из slug
                            echo '<p>'.$var_name.'</p>';
                        }
                        ?>
                    </div>
